stage2-bootmanager-host:
	...
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/utils.o $(BOOTLOADER_STAGE2)/utils.c
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/restring.o $(BOOTLOADER_STAGE2)/restdlibs/string.c
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/restdlib.o $(BOOTLOADER_STAGE2)/restdlibs/stdlib.c
	...
	$(LINKER) $(LINKER_FLAGS) -T $(BOOTLOADER_STAGE2)/linker.ld -o $(BUILD_DIR)/bootmanager.bin $(BUILD_DIR)/entry.o $(BUILD_DIR)/bootmanager.o $(BUILD_DIR)/restdio.o $(BUILD_DIR)/realmode.o $(BUILD_DIR)/protectedmode.o $(BUILD_DIR)/disk.o $(BUILD_DIR)/GDT.o $(BUILD_DIR)/utils.o $(BUILD_DIR)/restring.o $(BUILD_DIR)/restdlib.o
...
stage2-bootmanager-target:
	...
	$(TARGET_CC) $(TARGET_CFLAGS) -o $(BUILD_DIR)/restring.o $(BOOTLOADER_STAGE2)/restdlibs/string.c -D__32BIT__
	$(TARGET_CC) $(TARGET_CFLAGS) -o $(BUILD_DIR)/restdlib.o $(BOOTLOADER_STAGE2)/restdlibs/stdlib.c -D__32BIT__
	...
	$(TARGET_LINKER) $(TARGET_LINKER_FLAGS) -Wl,-Map=$(BUILD_DIR)/bootmanager.map -T $(BOOTLOADER_STAGE2)/linker.ld -o $(BUILD_DIR)/bootmanager.bin $(BUILD_DIR)/entry.o $(BUILD_DIR)/bootmanager.o $(BUILD_DIR)/restdio.o $(BUILD_DIR)/realmode.o $(BUILD_DIR)/protectedmode.o $(BUILD_DIR)/disk.o $(BUILD_DIR)/GDT.o $(BUILD_DIR)/utils.o $(BUILD_DIR)/restring.o $(BUILD_DIR)/restdlib.o
