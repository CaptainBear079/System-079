stage2-bootmanager-host:
	...
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/restdio.o $(BOOTLOADER_STAGE2)/stdio.c
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/disk.o $(BOOTLOADER_STAGE2)/disk.c
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/bootmanager.o $(BOOTLOADER_STAGE2)/bootmanager.c
	$(LINKER) $(LINKER_FLAGS) -T $(BOOTLOADER_STAGE2)/linker.ld -o $(BUILD_DIR)/bootmanager.bin $(BUILD_DIR)/entry.o $(BUILD_DIR)/bootmanager.o $(BUILD_DIR)/restdio.o $(BUILD_DIR)/realmode.o $(BUILD_DIR)/protectedmode.o $(BUILD_DIR)/disk.o $(BUILD_DIR)/utils.o
